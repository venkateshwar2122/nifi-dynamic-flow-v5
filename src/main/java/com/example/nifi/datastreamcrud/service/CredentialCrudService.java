...
import com.example.nifi.datastreamcrud.repository.CredentialRepository;
...
@Service
public class CredentialCrudService {

    private final CredentialRepository repository;

    public CredentialCrudService(CredentialRepository repository) {
